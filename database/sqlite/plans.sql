...
INSERT INTO "public"."plans" VALUES ('爬虫和数据分析', '13:00', '18:00', '通过python爬取其余网站数据进行分析', 'Python自动化爬取similarweb各大网站数据', 'Google自动爬虫和Youtube自动爬虫', '01:30', '03:00', '10%', 2, 'Automate the Boring Stuff w_ (Z-Library)', '数据挖掘、分析、统计', 'Te', '12', '2024', '知乎', 'Qoura', 'A', '工作相关实践', '增加某个网站爬虫', '2024-12-09', '1');
